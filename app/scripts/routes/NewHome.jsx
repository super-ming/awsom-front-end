      ...
      <main>
        <div className="main-wrapper">
          ...
          <div id="choose-adv" className="nav-down">
            <h1 style={{opacity:`${(this.state.opacity) ? '1' : '0' }`, transition: 'opacity .5s ease-in'}}>Choose Your Instrument</h1>
          </div>
            ...
            <div className="row">
              <div className="col-sm-5 offset-sm-1">
                <div className="cards">
                  ...
                  <div className="image-caption-wrapper">
                    <a className= "image-caption" href="https://www.awsom.info/piano/">Piano</a>
                  </div>
                </div>
              </div>
              <div className="col-sm-5">
                <div className="cards">
                  ...
                  <div className="image-caption-wrapper">
                    <a className= "image-caption" href="https://www.awsom.info/guitar/">Guitar</a>
                  </div>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-sm-5 offset-sm-1">
                <div className="cards">
                  ...
                  <div className="image-caption-wrapper">
                    <a className= "image-caption" href="https://www.awsom.info/drums/">Drums</a>
                  </div>
                </div>
              </div>
              <div className="col-sm-5">
                <div className="cards">
                  ...
                  <div className="image-caption-wrapper">
                    <a className= "image-caption" href="https://www.awsom.info/woodwind/">Woodwind</a>
                  </div>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-sm-5 offset-sm-1">
                <div className="cards">
                  ...
                  <div className="image-caption-wrapper">
                    <a className= "image-caption" href="https://www.awsom.info/voice/">Voice</a>
                  </div>
                </div>
              </div>
              <div className="col-sm-5">
                <div className="cards">
                  ...
                  <div className="image-caption-wrapper">
                    <a className= "image-caption" href="https://www.awsom.info/piano/">Brass</a>
                  </div>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-sm-5 offset-sm-1">
                <div className="cards">
                  ...
                  <div className="image-caption-wrapper">
                    <a className= "image-caption" href="https://www.awsom.info/strings/">Strings</a>
                  </div>
                </div>
              </div>
              <div className="col-sm-5">
                <div className="cards">
                  <img src="https://images.pexels.com/photos/1049690/pexels-photo-1049690.jpeg?cs=srgb&dl=brass-hand-instrument-1049690.jpg&fm=jpg" />
                  <div className="image-caption-wrapper">
                    <a className= "image-caption" href="https://www.awsom.info/chamber/">Chamber</a>
                  </div>
                </div>
              </div>
            </div>
